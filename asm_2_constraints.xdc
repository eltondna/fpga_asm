...
set_property PACKAGE_PIN U3 [get_ports {state_led[1]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {state_led[1]}]
set_property PACKAGE_PIN W3 [get_ports  {state_led[0]}]					
...
set_property PACKAGE_PIN W19 [get_ports r_btn]					
set_property IOSTANDARD LVCMOS33 [get_ports r_btn]

set_property PACKAGE_PIN T17 [get_ports c_btn]					
